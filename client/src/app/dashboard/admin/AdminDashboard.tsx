  ...
  return (
    <Box sx={{ display: 'flex', minHeight: '100vh', flexDirection: { xs: 'column', md: 'row' } }}>
      ...
      >
        ...
        {tab === 'athletes' && <AthleteManagement openDialog={athleteDialogOpen} onCloseDialog={() => setAthleteDialogOpen(false)} />}
        ...
        {tab === 'contacts' && <ContactManagement openDialog={contactDialogOpen} onCloseDialog={() => setContactDialogOpen(false)} />}
        {tab === 'reports' && <Reports />}
        {tab === 'settings' && (
          <Settings />
        )}
